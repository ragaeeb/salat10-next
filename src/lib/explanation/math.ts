...
export const normalizeToScale = (num: number, max: number) =>
...
export const dateByAddingSeconds = (date: Date, seconds: number) =>
...
export const evaluateSeasonalAdjustment = (
  dyy: number,
  a: number,
  b: number,
  c: number,
...
export const approximateTransit = (
  longitude: number,

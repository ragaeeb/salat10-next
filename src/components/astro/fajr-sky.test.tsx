...
import { FajrGradient } from './fajr-sky';

describe('FajrGradient', () => {
    describe('rendering', () => {
        it('should render without crashing with number opacity', () => {
            const { container } = render(<FajrGradient opacity={0.5} />);
        ...
        it('should render without crashing with MotionValue opacity', () => {
            ...
            const { container } = render(<FajrGradient opacity={opacityValue} />);
        ...
        it('should apply gradient background', () => {
            const { container } = render(<FajrGradient opacity={1} />);
    ...
    describe('opacity', () => {
        it('should handle opacity 0', () => {
            const { container } = render(<FajrGradient opacity={0} />);
    ...
    describe('edge cases', () => {
        it('should handle opacity values outside 0-1 range', () => {
            const { container: container1 } = render(<FajrGradient opacity={-0.5} />);
            expect(container1.querySelector('div')).toBeDefined();

            const { container: container2 } = render(<FajrGradient opacity={1.5} />);
